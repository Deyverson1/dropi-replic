  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/soluciones-para-proveedores/"
          element={<SuppliersSolutions />}
        />
        <Route
          path="/soluciones-para-dropshippers/"
          element={<DropshipperSolutions />}
        />
        <Route
          path="/soluciones-para-marca-propia/"
          element={<BrandSolutions />}
        />
