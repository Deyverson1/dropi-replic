/**
 * The function `Footer` returns JSX elements for a website footer with links and social media icons.
 * @returns The `Footer` component is being returned. It consists of a footer container with various
 * sections such as footer links, contact information, and social media links. The footer includes
 * links to different pages, contact details, and icons for social media platforms like Facebook,
 * YouTube, Instagram, Twitter, LinkedIn, and TikTok. Additionally, there is a copyright text at the
