/**
 * The Header component in this JavaScript React code renders a navigation bar with links and a mobile
 * menu icon that toggles a dropdown menu.
 */
...
export default function Header(props) {
  ...
  const { color } = props
  const dataHeader = [
    { title: 'Dropicard', to: '/Dropicard/', type: 'Link' },
    { title: '¿Qué perfil eres?', to: '/#Panels', background: '#55595c', color: '#fff' },
    // { title: 'Proveedores', to: '/Proveedores-premium/', type: 'Link' }, 
    { title: 'Iniciar sesión', to: '/Iniciar-sesion/', type: 'Link' },]
  return (
