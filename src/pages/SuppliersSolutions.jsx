...
function SuppliersSolutions() {
  ...
  const contentProduct = [
    "CARGA TU STOCK A NUESTRA PLATAFORMA PARA QUE LOS DROPSHIPPERS LOS VENDAN Y DESPACHA AL CLIENTE FINAL",
  ];
  ...
  return (
    <section>
      ...
      <ProductCard
        ...
        image={
          "https://dropi.co/wp-content/uploads/2023/05/proveedores_hero.png"
        }
      />
      ...
      <section className="suppliers-card-container">
        <h2>
          Conviértete en <em>un proveedor</em>
        </h2>
        <h1>Verificado</h1>
      ...
      <section className="suppliers-attach-announce">
        ...
        <div>
          <img
            src="https://dropi.co/wp-content/uploads/2023/05/proveedores_como_funciona.png"
            alt=""
          />
        </div>
      </section>
